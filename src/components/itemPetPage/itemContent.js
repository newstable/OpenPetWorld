...
function ItemContent(props){
    ...
    async function getAge(){
        var age = (await PetContract.levelInfos(tokenID)).toString();
    ...
    const handleBread = ()=>{
        setAlertInfos({title:"Cooming soon",info:"In the breeding feature you can breed your pet and get new eggs with the next generation gene and develop new skills"});
        setAlertOpen(true);
    }
