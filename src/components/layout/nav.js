...
function Nav(){
    ...
    const desktopContent = (
        <div className = "x-navContainer">
            <Link to = "/" className = "x-logo"><img src = {logoImg} alt = "logo" width = "100px"/></Link>
            <Link to = "/" className = "x-navLink">Home</Link>
            <ScrollLink to = "about" spy={true} smooth={true} className = "x-navLink">About Game</ScrollLink>
            <ScrollLink to = "features" spy={true} smooth={true} className = "x-navLink">Features</ScrollLink>
            <Link to = "/tokenomics" className = "x-navLink">Tokenomics</Link>
            <Link to = "/defi" className = "x-navLink">Defi</Link>
            <Link to = "/nft-marketplace" className = "x-navLink">NFT marketplace</Link>
            <Link to = "/my-items" className = "x-navLink">My Items</Link>
            <button className = "x-smallChoco-1" onClick={handleConnect}> {wallet.status === 'connected' ?styledAddress:"CONNECT"} </button>
            <button className = "x-smallGreen" >Play Now(soon) </button>
        </div>
    )
    const mobileContent = (
        <div className = "x-navContainer">
            <Link to = "/" className = "float-left"><img src = {logoImg} alt = "logo" width = "100px"/></Link>
        ...
        <div>
            ...
            <div>
                ...
                >
                    ...
                    */}
                    <StyledMenuItem onClick = {()=>console.log("connect button is clicked")}>
                    <ListItemIcon>
                        <InboxIcon fontSize="small" />
                    </ListItemIcon>
